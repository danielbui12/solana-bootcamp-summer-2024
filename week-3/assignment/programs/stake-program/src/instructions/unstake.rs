...
pub fn unstake(ctx: Context<Unstake>, amount: u64) -> Result<()> {
    ...
    let reward = slot_passed.checked_mul(reward_amount_per_slot)
        .unwrap(); // Handling potential overflow
    ...
    if reward > 0 {
        ...
        let reward_vault_signer_seeds: &[&[&[u8]]] = &[&[REWARD_VAULT_SEED, mint.as_ref(), &[reward_vault_bump]]];
        transfer(
